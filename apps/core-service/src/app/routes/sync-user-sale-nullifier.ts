...
/**
 * sync User sale Nullifier
 */
export const syncUserSaleNullifier: FastifyPlugin = async function (
    instance,
    options,
    done
): Promise<void> {
...
const schema = {
    description: 'sync user sale nullifiers',
    tags: ['Maintain nullifiers Tree'],
    response: {
        200: {
            type: 'object',
            properties: {
