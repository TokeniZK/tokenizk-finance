...
import { SaleRollupProver, TokeniZkFairSale, SaleRollupProof, SaleParams } from "@tokenizk/contracts";
        ...
        switch (message.type) {
            ...
            case `CONTRACT_CALL`:
                await execCircuit(message, async () => {
                    ...
                    const saleContract = new TokeniZkFairSale(params.contractAddress, TokenId.derive(params.tokenAddress));
