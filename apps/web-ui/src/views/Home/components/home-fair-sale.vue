...
<template>
    <el-row class="row-bg fair-sales" justify="center">
        <el-col :span="24">

            <!-- 标题+按钮 -->
            <el-row class="row-bg fair-sales-content" justify="center">

                <el-col :span="10">
                    <el-row>
                        <h2 class="title"> Hot Fair Sales </h2>
                    </el-row>
                ...
                <el-col :span="8" class="link">
                    <el-row class="mb-4" justify="end">
                        <router-link to="/sales?saleType=1" class="main-btn">
            ...
            <!-- 轮播图 -->
            <el-row class="row-bg fair-sales-carousel" justify="center">
