            ...
            <el-col :span="24">
              ...
              <el-form ref="ruleFormRef" :model="saleDto" :rules="rules" label-width="120px" class="demo-ruleForm"
                        ...
                        <el-row>
                          <el-col :span="8" hidden="true">
                            <el-form-item label="Token address" prop="tokenAddress">
                              <el-input v-model.trim="saleDto.tokenAddress" placeholder="Ex: Mina" />
                            </el-form-item>
                          </el-col>
                          <el-col :span="8">
                ...
                <el-row class="row-bg" justify="center" style="margin-top: 50px;">
                  ...
                  <el-col :span="6">
                    <el-form-item>
                      <el-button class="steps-Bar" @click="prev" type="primary" :disabled="!saleDto.tokenSymbol"
                        size="large">back</el-button>
                      <el-button class="steps-Bar" @click="next" type="primary" size="large" v-show="flagX != 3"
                        :disabled="!saleDto.tokenSymbol">Next
                      </el-button>
