...
const rules = reactive<FormRules<RuleForm>>({
  ...
  // 步骤3
  airdropName: [
    { required: true, message: 'Please input Airdrop Name', trigger: 'blur' },
                ...
                <el-row class="row-bg formTable1" v-show="flagX === 0">
                  ...
                  <el-col :span="24">
                    <el-form-item label="Token address" prop="tokenAddress">
                      ...
                      <div class="form-notes">Create airdrop fee: 0.1 Mina</div>
                    </el-form-item>
                  </el-col>
                    ...
                    <el-row class="row-bg">
                      <el-col :span="24">
                        <el-form-item label="Airdrop Name" prop="airdropName">
                          <el-input v-model.trim="ruleForm.airdropName" placeholder="Ex: Mina" />
                        </el-form-item>
                      </el-col>
                    </el-row>
