...
export const SALE_ACTION_BATCH_SIZE = 2;
...
export const USER_NULLIFIER_TREE_INIT_ROOT = INDEX_TREE_INIT_ROOT_8;

export const FEE_ASSET_ID_SUPPORT_NUM = 2;

export const CONTRIBUTORS_TREE_HEIGHT = 12;
export const CONTRIBUTORS_TREE_ROOT = STANDARD_TREE_INIT_ROOT_12;

export const WHITELIST_TREE_HEIGHT = 8;
export const WHITELIST_TREE_ROOT = STANDARD_TREE_INIT_ROOT_8;
