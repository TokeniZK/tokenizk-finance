...
let redeemAccountZkAppKey = PrivateKey.fromBase58('EKEkj9pHm1H39RAukSCSFF2SVDknAxsd5GFGt5G7xjcX3gNNzPy5');// (await ctx.getFundedAccountForTest(BigInt(1000 * (10 ** 9)), '')) //Local.testAccounts[5].privateKey;
